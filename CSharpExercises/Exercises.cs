...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        public static bool CanOpenCheckingAccount(int cusAge)
        {
            if (cusAge >= 18)
            {
                return true;
        ...
        public static string GetMilesPerHour(double distance, int hours, int minutes, int seconds)
        {
            ...
            string totalMph = Math.Round(mph).ToString();
            return totalMph + "MPH";
        }
        ...
        public static bool IsVowel(char letter)
        {
            ...
            bool results = vowels.Contains(letter);
            return results;
        }
